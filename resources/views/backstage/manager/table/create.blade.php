...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                <font color="#000000" face="微軟正黑體"><i class="fa fa-plus-circle"></i>排列餐桌</font>
            </h1>
        </div>
    </div>
    <!-- /.row -->
    ...
    <div class="row justify-content-center">
        <form action="{{ route('backstage.manager.table.index') }}" method="POST" role="form">
            {{ csrf_field() }}
            ...
            <div id="mainContainer">
                <div id="capitals">
                    ...
                    <div id="dropContent">
                        ...
                        @for($i=1;$i<217;$i++)
                            <input class="form-control col-md-6 hidden" type="text" id={{$i}} name="number">
{{--                            <input class="form-control col-md-6 hidden" type="text" id={{$i/60}} name="row">--}}
{{--                            <input class="form-control col-md-6 hidden" type="text" id={{$i%60+2}} name="col">--}}
            ...
            <div id="debug"></div>
            <button type="submit" id="submit" style="text-decoration:none; float: right;" class="btn btn-primary">儲存</button>
        </form>
    </div>
