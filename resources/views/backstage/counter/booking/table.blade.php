...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <font color="#000000" size="5px" face="微軟正黑體">Step1->選擇座位</font>
        </div>
    </div>
    <div class="progress">
                                ...
                                <li class="seat">
                                    @foreach($tables as $table)
                                        @if($table->row == $i && $table->col == $k)
                                            @if($table->status == "空閒中")
                                                <input type="checkbox" id="{{$table->table}}" name="table" value="{{$table->table}}">
        ...
        <div class="row">
            <div class="col-lg-12">
                <button type="button" style="text-decoration:none; float: right;" class="btn btn-primary">下一步</button>
            </div>
        </div>
    </form>
@endsection
